...
import static com.cloudorz.openmonitor.feature.keyattestation.attestation.AuthorizationList.*;
...
class EatClaim {
    ...
    public static final int USAGE_COUNT_LIMIT = PRIVATE_BASE - (KEYMASTER_TAG_TYPE_MASK & KM_TAG_USAGE_COUNT_LIMIT);
    ...
    public static final int ATTESTATION_ID_SECOND_IMEI = PRIVATE_BASE - (KEYMASTER_TAG_TYPE_MASK & KM_TAG_ATTESTATION_ID_SECOND_IMEI);
    public static final int MODULE_HASH = PRIVATE_BASE - (KEYMASTER_TAG_TYPE_MASK & KM_TAG_MODULE_HASH);
